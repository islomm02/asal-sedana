...
function OrderPage() {
  ...
  }} onClick={() => navigate("/")} className="bg-[#152529] absolute top-5 left-5 text-white font-semibold px-6 md:px-10 py-4 rounded-[20px] hover:shadow-lg transition-all duration-300">
        <ArrowLeftOutlined /> Orqaga
      </button>
      
            </div>
            <div className="pt-[200px] flex flex-col justify-center ">

                <div className="flex flex-col gap-3 justify-center items-center">
                    <h1 className="mt-[10px] text-center text-[40px] font-bold px-[400px]">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="w-[560px] mx-auto flex flex-col gap-4">
                        ...
                        <button
                            type="submit"
                            className="bg-[#ff7300] text-white text-[20px] rounded-md h-12 w-[560px]"
                            disabled={isLoading}
                        >
                            {isLoading
                                ? "Yuborilmoqda..."
