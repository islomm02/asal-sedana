    ...
    return (
        ...
        >
            ...
            <div className=" flex flex-col  items-center justify-center  text-center text-white">
                <div
                    id="header"
                    className="bg-[rgba(0,0,0,0.5)]  pt-20 h-full pb-5 sm:h-90 max-w-4xl px-6"
                >
                    ...
                    <h2 className="text-black text-[20px] font-semibold mt-2">
                        Sog‘lom hayot uchun tanlang – ishonchli va halol
                        manbadan!
                    </h2>
                </div>
                    ...
                    <div className="flex flex-col  sm:flex-row  md:flex-row items-center justify-center gap-10 max-w-[1200px] mx-auto">
                        ...
                        <div className=" w-[95%]   text-center sm:w-[550px] sm:text-start text-white flex flex-col gap-4 p-6 md:p-10">
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Qon bosimi , qandli diabet , prostata va buyrak
                                muammolarida yordam beradi
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                ...
                <div id="white-bg" className=" w-full  py-10 md:p-2 px-6">
                    <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-[1200px] mx-auto">
                        ...
                        >
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Yallig'lanishlarga garshi kuchli vosita! <br />{" "}
                                Bronxit, yo'tal va shamollashda ishonchli
                                yordamchi!
                                <br /> Nafas yo'llari uchun tabiiy himoya!
                                <br /> Immunitetni ko'taradi, viruslarga garshi
                                kurashadi!
                                <br /> Qorinning shishini, og'riqni kamaytiradi!
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-[1200px] mx-auto">
                        ...
                        >
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Immunitetni mustahkamlaydi, kuch-quvvat beradi
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Asal - shamollash, yo'tal va sovuqda eng yaxshi
                                yordamchi
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Asal - bolalar, keksa va homilador ayollar uchun
                                ham foydali
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Hech qanday qo'shimcha va shakar yo'q ﻿faqat sof
                                tabiat!
                            </h3>
                        </div>
                    </div>
                ...
                <div className="white-bg w-full  py-5 px-6">
                    <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-[1200px] mx-auto">
                        ...
                        >
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Burun bitishi, allergiya va shamollashda tabiiy
                                yechim!
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                Bolalar va kattalar uchun mos, xavfsiz va tabiiy
                            </h3>
                        </div>
                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-[1200px] mx-auto">
                        ...
                        >
                            ...
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                 Aqliy faollik va xotirani kuchaytiradi - har
                                yoshdagilarga foydali!
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                 Yallig'lanishni kamaytiradi, bo'g'imlarni
                                himoya qiladi.
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                 Xolesterinni me'yorga tushiradi, qon
                                aylanishini yaxshilaydi.
                            </h3>
                            <h3 className="text-[#bac9b3] font-bold !text-start md:text-end sm:w-full">
                                 Ko'z nurini mustahkamlovchi eng muhim yog'
                                kislotalari - Omega 3 bilan!
                            </h3>
                        </div>
                    </div>
                </div>
